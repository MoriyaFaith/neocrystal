	...
	const AZALEATOWN_AZALEA_ROCKET4
...
AzaleaTown_MapEvents:
	...
	object_event 11, 16, SPRITE_AZALEA_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownRocket2Script, EVENT_SLOWPOKE_WELL_ROCKETS
