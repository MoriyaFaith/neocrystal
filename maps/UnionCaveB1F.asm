...
UnionCaveB1F_MapEvents:
	...
	warp_event 31, 22, RUINS_OF_ALPH_OUTSIDE, 8
	warp_event 31,  3, UNION_CAVE_1F, 1
	warp_event  3, 33, UNION_CAVE_1F, 2
	warp_event 31, 31, UNION_CAVE_B2F, 1
	warp_event  7, 19, UNION_CAVE_1F, 5
	warp_event 30, 20, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 3
	...
	object_event 31, 30, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacCalvin, -1
	object_event  2, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, UnionCaveB1FTMSwift, EVENT_UNION_CAVE_B1F_TM_SWIFT
	object_event  6, 10, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, UnionCaveB1FBoulder, -1
