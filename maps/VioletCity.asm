...
VioletCity_MapEvents:
	...
	warp_event 21, 33, VIOLET_KYLES_HOUSE, 1
	warp_event 23,  5, SPROUT_TOWER_1F, 1
	warp_event 39, 28, ROUTE_31_VIOLET_GATE, 1
	warp_event 39, 29, ROUTE_31_VIOLET_GATE, 2
	warp_event 19, 21, VIOLET_GYM, 2

	def_coord_events

	def_bg_events
	bg_event 24, 24, BGEVENT_READ, VioletCitySign
	bg_event 15, 21, BGEVENT_READ, VioletGymSign
	bg_event 25,  7, BGEVENT_READ, SproutTowerSign
	bg_event 27, 21, BGEVENT_READ, EarlsPokemonAcademySign
	bg_event 32, 29, BGEVENT_READ, VioletCityPokecenterSign
	...
	object_event 28, 32, SPRITE_LASS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, VioletCityLassScript, -1
	object_event 24, 18, SPRITE_PSYCHIC, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, VioletCitySuperNerdScript, -1
	object_event 17, 24, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletCityGrampsScript, -1
	...
	object_event  4,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VioletCityPPUp, EVENT_VIOLET_CITY_PP_UP
