...
RuinsOfAlphInnerChamber_MapEvents:
	...
	warp_event  3, 13, RUINS_OF_ALPH_HO_OH_CHAMBER, 3
	warp_event  4, 13, RUINS_OF_ALPH_HO_OH_CHAMBER, 4
	...
	bg_event 17, 27, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 10, 18, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 14, 27, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	...
	bg_event 18, 27, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 10, 24, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 11, 27, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 17, 24, BGEVENT_READ, RuinsOfAlphInnerChamberStatue

	def_object_events
	object_event  4, 10, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberFisherScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
	object_event 15, 13, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberTeacherScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
	object_event 10, 20, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberGrampsScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
