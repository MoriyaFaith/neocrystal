...
VioletCity_MapEvents:
	...
	object_event 24, 14, SPRITE_PSYCHIC, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, VioletCitySuperNerdScript, -1
