...
Route3_MapEvents:
	...
	def_object_events
	object_event 26, 12, SPRITE_FIREBREATHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerFirebreatherOtis, -1
	...
	object_event 49,  5, SPRITE_FIREBREATHER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerFirebreatherBurt, -1
