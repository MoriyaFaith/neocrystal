...
MapGroup_Violet:
	...
	map Route32Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_RUINS_OF_ALPH, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map CianwoodPharmacy, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_48, MUSIC_ROUTE_47, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_HGSSExpansion:
	table_width MAP_LENGTH, MapGroup_HGSSExpansion
	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CliffCave, TILESET_CAVE, CAVE, LANDMARK_CLIFF_CAVE, MUSIC_ROUTE_47, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_HGSS_ROUTES_MAPS