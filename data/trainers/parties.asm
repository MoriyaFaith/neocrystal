...
FalknerGroup:
	...
	db  13, DODUO,  TACKLE, MUD_SLAP, PECK, QUICK_ATTACK
	db -1 ; end
...
YoungsterGroup:
	...
	db 26, FURRET,	   SLAM, THUNDERPUNCH, QUICK_ATTACK, ENDURE
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 42, FURRET,	   SLAM, THUNDERPUNCH, QUICK_ATTACK, ENDURE
	db 43, GRANBULL,   CRUNCH, TAKE_DOWN, ROAR, ICE_PUNCH
	db 44, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 52, FURRET,	   BODY_SLAM, THUNDERPUNCH, QUICK_ATTACK, PROTECT
	db 53, GRANBULL,   CRUNCH, TAKE_DOWN, ROAR, ICE_PUNCH
	db 55, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 44, LEDIAN,     MACH_PUNCH, COMET_PUNCH, SUPERSONIC, SAFEGUARD
	db 44, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 45, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 44, ARIADOS,    NIGHT_SHADE, SPIDER_WEB, LEECH_LIFE, SLUDGE_BOMB
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 51, LEDIAN,     MACH_PUNCH, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH
	db 50, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 52, BEEDRILL,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 51, ARIADOS,    NIGHT_SHADE, SPIDER_WEB, LEECH_LIFE, SLUDGE_BOMB
	db -1 ; end
