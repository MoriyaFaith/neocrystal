...
BurglarSpriteGFX::             INCBIN "gfx/sprites/schoolboy.2bpp"
CamperSpriteGFX::              INCBIN "gfx/sprites/bird_keeper.2bpp"
FirebreatherSpriteGFX::		   INCBIN "gfx/sprites/boarder.2bpp"
HikerSpriteGFX::               INCBIN "gfx/sprites/skiier.2bpp"
PicnickerSpriteGFX::           INCBIN "gfx/sprites/schoolboy.2bpp"
PokemaniacSpriteGFX::          INCBIN "gfx/sprites/bird_keeper.2bpp"
PsychicSpriteGFX::		       INCBIN "gfx/sprites/boarder.2bpp"