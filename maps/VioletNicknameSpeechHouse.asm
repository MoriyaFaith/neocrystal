...
VioletNicknameSpeechHouse_MapEvents:
	...
	object_event  5,  2, SPRITE_SPEAROW, SPRITEMOVEDATA_POKEMON, 1, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, VioletNicknameSpeechHouseBirdScript, -1
