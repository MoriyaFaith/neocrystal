...
MortyGroup:
	...
	db 24, GASTLY,     NO_ITEM,      LICK, SPITE, MEAN_LOOK, CURSE
	db 24, HAUNTER,    NO_ITEM,      HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
...
JasmineGroup:
	...
	db 31, MAGNEMITE,  NO_ITEM,      THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, SKARMORY,   NO_ITEM,      DRILL_PECK, STEEL_WING, CURSE, PROTECT
	db 33, MAGNETON,   NO_ITEM,      THUNDERBOLT, RAIN_DANCE, PROTECT, THUNDER_WAVE
