...
Rival1Group:
	...
	db 41, KINGDRA,    $DD, $DD, SURF, DRAGONBREATH, ICE_BEAM, SWAGGER
	...
	db 40, KINGDRA,    $DD, $DD, SURF, DRAGONBREATH, ICE_BEAM, SWAGGER
	...
	; RIVAL1 (16 - New Battle)
	db "?@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db 35, GYARADOS,   $FA, $AA, DRAGONBREATH, CRUNCH, SURF, THRASH			;Red Gyarados
	db 35, NIDORINO,   $DD, $DD, SLUDGE_BOMB, DOUBLE_KICK, TAKE_DOWN, THUNDERBOLT
	db 34, SEADRA,     $DD, $DD, SURF, DRAGONBREATH, ICE_BEAM, SWAGGER
	db 36, MEGANIUM,   $DD, $DD, REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db 37, SNEASEL,    $DD, $DD, ICE_PUNCH, FAINT_ATTACK, CUT, SWORDS_DANCE
	db -1 ; end

	; RIVAL1 (17 - New Battle)
	db "?@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db 35, GYARADOS,   $FA, $AA, DRAGONBREATH, CRUNCH, SURF, THRASH			;Red Gyarados
	db 35, NIDORINO,   $DD, $DD, SLUDGE_BOMB, DOUBLE_KICK, TAKE_DOWN, THUNDERBOLT
	db 34, WEEPINBELL, $DD, $DD, SURF, DRAGONBREATH, ICE_BEAM, SWAGGER
	db 36, TYPHLOSION, $DD, $DD, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db 37, SNEASEL,    $DD, $DD, ICE_PUNCH, FAINT_ATTACK, CUT, SWORDS_DANCE
	db -1 ; end

	; RIVAL1 (18 - New Battle)
	db "?@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db 35, GYARADOS,   $FA, $AA, DRAGONBREATH, CRUNCH, SURF, THRASH			;Red Gyarados
	db 35, NIDORINO,   $DD, $DD, SLUDGE_BOMB, DOUBLE_KICK, TAKE_DOWN, THUNDERBOLT
