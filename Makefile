...
neocrystal11_debug_obj := $(rom_obj:.o=11_debug.o)
...
crystal11_debug: neocrystal11_debug.gbc
...
$(foreach obj, $(neocrystal11_debug_obj), $(eval $(call DEP,$(obj),$(obj:11_debug.o=.asm))))
